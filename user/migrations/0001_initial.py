# Generated by Django 5.2.1 on 2025-11-14 18:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('task', 'Task'), ('goal', 'Goal')], default='goal', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='user.goal')),
            ],
        ),
    ]
